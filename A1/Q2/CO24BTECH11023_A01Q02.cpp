...
void solveFTCS(vector<double> &u, const vector<double> &x, double dt, double dx, double c, int Nt, int Nx, const vector<double> &output_times)
{
...
int main()
{
    ...
    solveFTCS(u, x, dt, dx, c, Nt, Nx, output_times);
